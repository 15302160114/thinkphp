<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"C:\xampp\htdocs\thinkphp\public/../application/admin\view\adminhotai\dis_edit.html";i:1530578647;}*/ ?>
<!DOCTYPE html>
<html class=" ">
    <head>
        <!-- 
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            ...
                            <form class="form-horizontal" method="post" name="form1" action="<?php echo url('adminhotai/dis_update'); ?>">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <input type="hidden" name="id"placeholder="id" value="<?php echo $distributor['id']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group primary">
                                            ...
                                            <input type="text" class="form-control" name="realname" value="<?php echo $distributor['realname']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group primary">
                                            ...
                                            <input type="text" class="form-control" name="tel" value="<?php echo $distributor['tel']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group primary">
                                            ...
                                            <input type="text" class="form-control" name="email" value="<?php echo $distributor['email']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group primary">
                                            ...
                                            <input type="text" class="form-control" name="note" value="<?php echo $distributor['note']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group primary">
                                            ...
                                            <input type="password" class="form-control" name="password" value="<?php echo $distributor['password']; ?>">
                                        </div>
