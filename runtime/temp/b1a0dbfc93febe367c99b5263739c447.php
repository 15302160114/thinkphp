                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" >
                                ...
                                <li>
                                    <a class="active" href="order.html">订单详情</a>
                                </li>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">订单详情</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    ...
                                    <form id="general_validate" action="<?php echo url('adminhotai/orderUpdate'); ?>" method="post" novalidate="novalidate">

                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <input type="hidden" name="id" placeholder="id" value="<?php echo $order['id']; ?>">

                                            <div class="form-group">
                                                <label class="form-label" for="formfield1">商品名称</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="<?php echo $order['spname']; ?>" class="form-control" id="formfield1" name="spname" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="<?php echo $order['count']; ?>" class="form-control" id="formfield1" name="count" >
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label" for="formfield1">总价</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="<?php echo $order['sum']; ?>" class="form-control" id="formfield1" name="sum" >
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label" for="formfield1">配送员</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="formfield6">下单时间</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="<?php echo $order['create_time']; ?>" class="form-control" id="formfield6" name="create_time" >
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label" for="formfield7">备注</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control" value="<?php echo $order['description']; ?>" id="formfield7" name="description" >
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label" for="formfield7">STATUS</label>
                                                <span class="desc"></span>
                                                <div class="controls">
