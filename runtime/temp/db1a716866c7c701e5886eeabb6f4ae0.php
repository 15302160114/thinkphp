<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\xampp\htdocs\thinkphp\public/../application/distributor\view\distributor\order.html";i:1530679401;}*/ ?>
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <form method="post" action="<?php echo url('distributor/update_o',['id'=>$vo['id']]); ?>">
                                                    <td>
